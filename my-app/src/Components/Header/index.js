...
import {faAccessibleIcon, faFacebook, faInstagram, faScreenpal} from '@fortawesome/free-brands-svg-icons';
import {faAddressCard, faBagShopping, faBell,faCartShopping,faDesktop,faHouse,faLaptop,faMagnifyingGlass, faScrewdriver, faSection, faSimCard, faSquare, faTableList, faWifi} from '@fortawesome/free-solid-svg-icons';
